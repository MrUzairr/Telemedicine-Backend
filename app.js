...
const FLASK_PORT = 5000; // Flask Server Port
const FLASK_URL = `http://127.0.0.1:${FLASK_PORT}`;


// Start the Flask Service
const flaskProcess = spawn("python", ["E:/7th Semester/FYP/Development/Disease Prediction/prediction_app.py"], {
...
// API Gateway: Proxy Node.js Request to Flask using POST
app.post("/flask-api", async (req, res) => {
  try {
      ...
      res.status(500).send("Flask Service Unavailable");
  }
});
